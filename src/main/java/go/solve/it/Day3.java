...
import static go.solve.it.util.Primitives.ints;
import static go.solve.it.util.Streams.zip;
import static java.util.Arrays.stream;

public final class Day3 {

    public static void main(final String... args) {
        System.out.println(part1(asGrid(Input.lines("day3/input"))));
        System.out.println(part2(asGrid(Input.lines("day3/input"))));
    }
