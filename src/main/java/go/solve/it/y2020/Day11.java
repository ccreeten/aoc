...
import static go.solve.it.util.container.Arraysβ.count;
import static go.solve.it.util.stream.BiStream.streamPositions;
import static go.solve.it.util.stream.StreamOps.single;
...
public final class Day11 {
    ...
    public static void main(final String... args) {
        System.out.println(part1(Input.grid("y2020/day11/input")));
        System.out.println(part2(Input.grid("y2020/day11/input")));
    }
