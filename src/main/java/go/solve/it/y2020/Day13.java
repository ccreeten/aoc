...
import go.solve.it.util.container.Tuple.LongTuple;
import go.solve.it.util.input.Input;

import java.util.Scanner;

import static go.solve.it.util.stream.BiStream.streamIndexed;
...
public final class Day13 {
    ...
    public static void main(final String... args) {
        try (Scanner scanner = Input.scan("y2020/day13/input")) {
